...
$stmt = $conn->prepare("SELECT FirstName, LastName, Program, profile_picture FROM users LEFT JOIN user_information ON users.student_id = user_information.student_id WHERE user_id = ?");
