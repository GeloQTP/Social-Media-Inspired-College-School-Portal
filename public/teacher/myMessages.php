...
$stmt = $conn->prepare("SELECT account_username, profile_picture, Program, YearLevel FROM users LEFT JOIN user_information ON users.student_id = user_information.student_id WHERE user_id = ?");
...
<body>
    ...
    <div class="main p-md-2 p-1" style="margin-top: 4rem;">
        ...
        <div class="row g-3">
            ...
            <div class="col-lg-7">
                <?php
                include __DIR__ . '/components/messages.php'; // STUDENT SIDEBAR
                ?>
            </div>
            ...
            <div class="col-lg-3 text-center d-flex flex-column">
                ...
                <div class="card mt-2 mx-auto" style="width: 100%;">
                    <div class="card-header bg-success bg-gradient border-0 text-light">
                        <small>BADGES</small>
                    </div>
