...
<script>
    document.addEventListener("DOMContentLoaded", () => { // POST COMMENNT FUNCTION
        ...
        commentForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (!data.success) {
                    console.error("There was an error loading the comments");
                    return;
                }
                ...
                return `
                                ...
                                <div class="d-flex mb-2 border-bottom">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="d-flex">
                                            ${data.comment}
                                             <button onclick="deleteCommentConfirmation(${data.comment_id},${data.post_id})" class="btn btn-sm ms-auto me-1 text-danger"><i class="bi bi-trash h6"></i></button>
                                        </div>
    ...
    function deleteCommentConfirmation(comment_id, post_id) {
        Swal.fire({
            title: "Are you sure?",
