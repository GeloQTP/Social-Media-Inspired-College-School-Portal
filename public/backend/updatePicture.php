...
$filename = $_FILES['profilePicture']['name']; // only gets the base name (image.png).
...
$imagePathForDB = '/Modern Student Portal/public/Uploads/profile_pictures/' . $filename; // directory for database
