<nav class="navbar navbar-expand-lg bg-light border border-bottom fixed-top">
    ...
    <img src="/Modern Student Portal/src/img/TRC_LOGO.png" alt="TRC_LOGO" style="width: 50px;" class="ms-3 d-none d-lg-block"
        onclick="window.location.href=`/Modern%20Student%20Portal/public/alumni/alumniDashboard.php`">
...
<script>
    async function search_classmates(searchQueue) {
        ...
        try {
            ...
            const res = await fetch(`./../backend/alumniSearchbar.php`, {
                method: 'POST',
            ...
            const list = data.map(data => {
                ...
                return `
                <a href="/Modern%20Student%20Portal/public/alumni/viewProfile.php?user_id=${data.user_id}" class="dropdown-item d-flex align-items-center gap-2 rounded-3 py-2 border">
