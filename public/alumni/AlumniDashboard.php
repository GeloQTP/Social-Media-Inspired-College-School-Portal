...
$stmt = $conn->prepare("SELECT user_information.student_id, account_username, profile_picture, Program, GraduationYear FROM users LEFT JOIN user_information ON users.student_id = user_information.student_id WHERE user_id = ?");
...
<body>
    ...
    <?php
    include __DIR__ . '/components/alumniNavbar.php'; // ALUMNI NAVBAR
    ?>
    ...
    <div class="main p-md-2 p-1" style="margin-top: 4rem;">
        ...
        <div class="row g-3">
            ...
            <div class="col-lg-2">
                <?php
                include __DIR__ . '/components/alumniSideBar.php'; // ALUMNI SIDEBAR
                ?>
            </div>
